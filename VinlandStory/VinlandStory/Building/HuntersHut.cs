...
{
    public class HuntersHut : Building
    {
        ...
        public HuntersHut(int x, int y, Longhouse longhouse) : base(x, y, __HUT_LENGTH, __HUT_WIDTH, __HUT_COST, __HUT_RADIUS, __HUT_WORKERS, longhouse)
        {
